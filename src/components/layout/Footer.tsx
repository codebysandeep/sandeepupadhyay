      ...
      <div className="container-page py-10 lg:py-20">
        <div className="grid lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-4 pb-10 mb-10 border-b border-border lg:border-b-0 lg:mb-0 lg:pb-0">
            ...
            <div className="relative w-full sm:max-w-[260px] h-[300px] rounded-xl overflow-hidden mb-6 border border-border">
              <img
                src={profile.bgImage}
                alt=""
          ...
          <div className="lg:col-span-3 pb-10 mb-10 border-b border-border lg:border-b-0 lg:mb-0 lg:pb-0">
            <h3 className="display-5 text-foreground mb-6">
              Navigation
            </h3>
            <ul className="divide-y divide-border">
              {navItems.map((item) => (
                <li key={item.label}>
                  <a
                    href={item.href}
                    className="flex items-center min-h-[44px] py-2.5 lg:py-3 text-foreground hover:text-orange-700 dark:hover:text-orange-400 transition-colors"
                  >
                    {item.label}
                  </a>
                </li>
          ...
          <div className="lg:col-span-5 min-w-0">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="display-5 text-foreground">
                Stay Update
              </h3>
            </div>
            ...
            <form className="mb-4" onSubmit={(e) => e.preventDefault()}>
              <div className="flex flex-col gap-2 sm:flex-row">
                <input
                  ...
                  className="w-full sm:flex-1 px-4 py-3 bg-background dark:bg-stone-800 border border-border rounded-lg text-foreground placeholder-stone-400 dark:placeholder-stone-500 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors"
                  aria-label="Email address"
                />
                <button
                  type="submit"
                  className="w-full sm:w-auto px-6 py-3 bg-stone-950 dark:bg-white text-white dark:text-stone-900 font-medium rounded-lg hover:bg-stone-800 dark:hover:bg-stone-100 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-600 focus-visible:ring-offset-2"
                >
                  Subscribe
                </button>
              </div>
            ...
            <div className="flex items-center gap-2">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="w-11 h-11 rounded-full border border-border flex items-center justify-center text-foreground dark:text-stone-300 hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-500 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-600"
      ...
      <div className="border-t">
        <div className="container-page py-6">
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
            ...
            <p className="text-sm text-center sm:text-left text-muted-foreground order-2 sm:order-1">
              &copy; {currentYear} Sandeep Upadhyay. All rights reserved.
            </p>

            {/* Legal Links — above copyright on mobile, right on desktop */}
            <div className="flex items-center gap-6 text-sm text-foreground order-1 sm:order-2">
              <a
                href="#"
